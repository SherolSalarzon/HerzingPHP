...
// Host | username | password | database isset($_COOKIE['loggedin'])

$currentTime = time();
$time = $_SESSION['time']

if (isset($_SESSION['loggedin']) && $_SESSION['time'] <= time() + 120) {
...
<head>
	...
	<!-- BootStrap Styling -->
	<link rel="stylesheet" href="https://cdn.jsdelivr.net/npm/bootstrap@4.5.3/dist/css/bootstrap.min.css?v=<?php echo time(); ?>" integrity="sha384-TX8t27EcRE3e/ihU7zmQxVncDAy5uIKz4rEkgIXeMed4M0jlfIDPvg6uqKI2xXr2" crossorigin="anonymous">
...
<div class=" justify-content-end" id="navbarNav">
  <ul class=navbar-nav>
    ...
    <li class="nav-item active">
      <a href="loginPage.php?logout=true" class="nav-link active mx-1" id="LogOut">
        Sign Out
      </a>
    </li>
  </ul>
