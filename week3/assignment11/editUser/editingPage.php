        ...
        <div class="row">
          ...
          <div class="col">
            ...
            <select name="provinces" class="form-select" aria-label="Default select example" >
              ...
              <option value="Alberta" <?= $user['province'] == 'Alberta' ? 'selected' : '';?>
              >Alberta
              </option>

              <option value="British-Columbia" <?= $user['province'] == 'British-Columbia' ? 'selected' : '';?>>British Columbia
              </option>
          ...
          <div class="row">
            ...
            <div class="col mt-3 d-flex justify-content-end ">
              ...
              <button onclick="return cancelThis()" name="cancel-button" class="btn btn-danger btn-lg mx-1">Cancel</button>
            </div>
          </div>
        <?php
          }} else {
